...
;(() => {
  ...
  const JUNK_CLASS_REGEX =
    /^(svelte-[a-z0-9]+|style-scope|ytSpec[A-Za-z]+(Padding|Size[A-Z]|Enable|Elevated)|ytAttributedString[A-Za-z]+|notranslate)$/
  ...
  function showConfirmPanel(initialTarget) {
    ...
    function startZoomIn() {
      ...
      function isDescendant(el) {
        return el !== currentTarget && currentTarget.contains(el)
      }
